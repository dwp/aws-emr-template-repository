...
resource "aws_security_group_rule" "emr_template_host_outbound_tanium_1" {
  description              = "EMR Template host outbound port 1 to Tanium"
  type                     = "egress"
...
resource "aws_security_group_rule" "emr_template_host_outbound_tanium_2" {
  description              = "EMR Template host outbound port 2 to Tanium"
  type                     = "egress"
...
resource "aws_security_group_rule" "emr_template_host_inbound_tanium_1" {
  description              = "EMR Template host inbound port 1 from Tanium"
  type                     = "ingress"
  from_port                = var.tanium_port_1
  to_port                  = var.tanium_port_1
  protocol                 = "tcp"
...
resource "aws_security_group_rule" "emr_template_host_inbound_tanium_2" {
  description              = "EMR Template host inbound port 2 from Tanium"
  type                     = "ingress"
  from_port                = var.tanium_port_2
  to_port                  = var.tanium_port_2
  protocol                 = "tcp"
